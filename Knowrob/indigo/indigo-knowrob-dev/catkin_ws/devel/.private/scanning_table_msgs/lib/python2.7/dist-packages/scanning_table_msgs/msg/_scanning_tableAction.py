...
"""autogenerated by genpy from scanning_table_msgs/scanning_tableAction.msg. Do not edit."""
import sys
...
class scanning_tableAction(genpy.Message):
  _md5sum = "929fc3e1b4db4c1fb852d18d42f5940b"
  _type = "scanning_table_msgs/scanning_tableAction"
...
"""
  ...
  _slot_types = ['scanning_table_msgs/scanning_tableActionGoal','scanning_table_msgs/scanning_tableActionResult','scanning_table_msgs/scanning_tableActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(scanning_tableAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = scanning_table_msgs.msg.scanning_tableActionGoal()
      if self.action_result is None:
        self.action_result = scanning_table_msgs.msg.scanning_tableActionResult()
      if self.action_feedback is None:
        self.action_feedback = scanning_table_msgs.msg.scanning_tableActionFeedback()
    else:
      self.action_goal = scanning_table_msgs.msg.scanning_tableActionGoal()
      self.action_result = scanning_table_msgs.msg.scanning_tableActionResult()
      self.action_feedback = scanning_table_msgs.msg.scanning_tableActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2d3I.pack(_x.action_goal.goal.angle, _x.action_goal.goal.release_brake_timeout, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_d.pack(self.action_feedback.feedback.angle))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.angle, _x.action_goal.goal.release_brake_timeout, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.angle,) = _struct_d.unpack(str[start:end])
      return self
