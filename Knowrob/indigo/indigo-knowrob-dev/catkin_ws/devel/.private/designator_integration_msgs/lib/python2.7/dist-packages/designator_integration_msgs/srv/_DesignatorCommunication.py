...
class DesignatorCommunicationRequest(genpy.Message):
  _md5sum = "6949a26db11a1131db0d1dd5dc7c65c4"
...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_i.pack(self.request.designator.type))
      ...
      for val1 in self.request.designator.description:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_d.pack(val1.value_float))
        _x = val1.value_data
        length = len(_x)
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *val1.value_array))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.request.designator.type,) = _struct_i.unpack(str[start:end])
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.value_string = str[start:end].decode('utf-8')
        else:
          val1.value_string = str[start:end]
        start = end
        end += 8
        (val1.value_float,) = _struct_d.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        val1.value_array = struct.unpack(pattern, str[start:end])
        _v14 = val1.value_posestamped
        _v15 = _v14.header
        start = end
        end += 4
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _struct_4d.unpack(str[start:end])
        _v23 = val1.value_point
        _x = _v23
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        _v24 = val1.value_wrench
        _v25 = _v24.force
        _x = _v25
        start = end
        end += 24
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.request.designator.description:
        ...
        _x = _v35
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        _v36 = val1.value_point
        _x = _v36
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v37 = val1.value_wrench
        _v38 = _v37.force
        _x = _v38
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v39 = _v37.torque
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _struct_4d.unpack(str[start:end])
        _v49 = val1.value_point
        _x = _v49
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        _v50 = val1.value_wrench
        _v51 = _v50.force
        _x = _v51
        start = end
        end += 24
...
class DesignatorCommunicationResponse(genpy.Message):
  _md5sum = "b9c90c5e0202236f62833afc88aad194"
...
class DesignatorCommunication(object):
  ...
  _md5sum = '0e70f80d6997921ab87b1ae40059194f'
