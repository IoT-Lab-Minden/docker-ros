...
"""autogenerated by genpy from iai_robosherlock_msgs/SimplePerceiveObjectActionGoal.msg. Do not edit."""
import sys
...
class SimplePerceiveObjectActionGoal(genpy.Message):
  _md5sum = "e725fe0d0ef4d8607df62526cc177af5"
  _type = "iai_robosherlock_msgs/SimplePerceiveObjectActionGoal"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','iai_robosherlock_msgs/SimplePerceiveObjectGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SimplePerceiveObjectActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = iai_robosherlock_msgs.msg.SimplePerceiveObjectGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = iai_robosherlock_msgs.msg.SimplePerceiveObjectGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.goal.requests)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.requests:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.goal.requests.append(val1)
      return self
