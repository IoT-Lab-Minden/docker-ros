...
"""autogenerated by genpy from iai_robosherlock_msgs/SimplePerceiveObjectActionFeedback.msg. Do not edit."""
import sys
...
class SimplePerceiveObjectActionFeedback(genpy.Message):
  _md5sum = "fa092c6f56e640e0f21d2699c2d9e9e5"
  _type = "iai_robosherlock_msgs/SimplePerceiveObjectActionFeedback"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','iai_robosherlock_msgs/SimplePerceiveObjectFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SimplePerceiveObjectActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = iai_robosherlock_msgs.msg.SimplePerceiveObjectFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = iai_robosherlock_msgs.msg.SimplePerceiveObjectFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.feedback.percepts)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.percepts:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.feedback.percepts.append(val1)
      return self
