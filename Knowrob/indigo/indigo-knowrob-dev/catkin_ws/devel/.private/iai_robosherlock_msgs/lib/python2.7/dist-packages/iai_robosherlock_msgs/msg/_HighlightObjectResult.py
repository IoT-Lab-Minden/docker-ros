...
"""autogenerated by genpy from iai_robosherlock_msgs/HighlightObjectResult.msg. Do not edit."""
import sys
...
class HighlightObjectResult(genpy.Message):
  _md5sum = "3b318fb4681b460e023abdf197c698f4"
  _type = "iai_robosherlock_msgs/HighlightObjectResult"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HighlightObjectResult, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_B3I.pack(_x.found, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.found, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
