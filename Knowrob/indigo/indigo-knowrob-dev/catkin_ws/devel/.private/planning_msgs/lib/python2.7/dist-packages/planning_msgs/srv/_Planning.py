...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.pattern = str[start:end].decode('utf-8')
      else:
      ...
      for val1 in self.plans:
        ...
        for val2 in val1.steps:
          ...
          for val3 in val2.bindings:
            buff.write(_struct_i.pack(val3.type))
            _x = val3.key
            length = len(_x)
            if python3 or type(_x) == unicode:
              _x = _x.encode('utf-8')
            ...
            if python3:
              ...
              buff.write(struct.pack('<I%ss'%length, length, _x))
          buff.write(_struct_f.pack(val2.score))
          length = len(val2.duration)
          buff.write(_struct_I.pack(length))
          pattern = '<%sf'%length
          buff.write(struct.pack(pattern, *val2.duration))
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            val2.pattern = str[start:end].decode('utf-8')
          else:
          ...
          for i in range(0, length):
            ...
            (val3.type,) = _struct_i.unpack(str[start:end])
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            start = end
          ...
          (val2.score,) = _struct_f.unpack(str[start:end])
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          pattern = '<%sf'%length
          ...
          val2.duration = struct.unpack(pattern, str[start:end])
