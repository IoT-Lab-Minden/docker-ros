...
if("TRUE" STREQUAL "TRUE")
  set(rosprolog_SOURCE_PREFIX /root/catkin_ws/src/knowrob/rosprolog)
  set(rosprolog_DEVEL_PREFIX /root/catkin_ws/devel/.private/rosprolog)
  ...
  set(rosprolog_INSTALL_PREFIX /root/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosprolog' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Moritz Tenorth <knowrob@tenorth.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosprolog' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/knowrob/rosprolog/${idir}'.  Ask the maintainer 'Moritz Tenorth <knowrob@tenorth.de>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/rosprolog/lib;/root/catkin_ws/devel/lib;/home/ros/devel/lib;/opt/ros/indigo/lib)
...
set(rosprolog_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rosprolog_dep}_FOUND)
      find_package(${rosprolog_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rosprolog_dep} REQUIRED ${depend_list})
  endif()
