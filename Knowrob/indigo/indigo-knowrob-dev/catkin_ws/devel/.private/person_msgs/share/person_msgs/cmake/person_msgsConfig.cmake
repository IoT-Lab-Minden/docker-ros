...
if("TRUE" STREQUAL "TRUE")
  set(person_msgs_SOURCE_PREFIX /root/catkin_ws/src/iai_common_msgs/person_msgs)
  set(person_msgs_DEVEL_PREFIX /root/catkin_ws/devel/.private/person_msgs)
  ...
  set(person_msgs_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/devel/.private/person_msgs/include " STREQUAL " ")
  set(person_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/devel/.private/person_msgs/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'person_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jworch <jworch@cs.uni-bremen.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'person_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/iai_common_msgs/person_msgs/${idir}'.  Ask the maintainer 'jworch <jworch@cs.uni-bremen.de>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/person_msgs/lib;/root/catkin_ws/devel/lib;/home/ros/devel/lib;/opt/ros/indigo/lib)
...
set(person_msgs_EXPORTED_TARGETS "person_msgs_generate_messages_cpp;person_msgs_generate_messages_java;person_msgs_generate_messages_lisp;person_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${person_msgs_dep}_FOUND)
      find_package(${person_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${person_msgs_dep} REQUIRED ${depend_list})
  endif()
