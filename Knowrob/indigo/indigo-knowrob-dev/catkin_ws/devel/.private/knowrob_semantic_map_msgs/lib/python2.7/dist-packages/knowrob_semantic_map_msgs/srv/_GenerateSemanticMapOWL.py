...
"""autogenerated by genpy from knowrob_semantic_map_msgs/GenerateSemanticMapOWLRequest.msg. Do not edit."""
import sys
...
class GenerateSemanticMapOWLRequest(genpy.Message):
  _md5sum = "3236e705e162d6ba9e0bfae7b9d0cf43"
  _type = "knowrob_semantic_map_msgs/GenerateSemanticMapOWLRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GenerateSemanticMapOWLRequest, self).__init__(*args, **kwds)
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from knowrob_semantic_map_msgs/GenerateSemanticMapOWLResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GenerateSemanticMapOWLResponse(genpy.Message):
  _md5sum = "dc9efc63bb72e9c68ed58c7eee542724"
  _type = "knowrob_semantic_map_msgs/GenerateSemanticMapOWLResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string owlmap
"""
  __slots__ = ['owlmap']
  _slot_types = ['string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GenerateSemanticMapOWLResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.owlmap is None:
        self.owlmap = ''
    else:
      self.owlmap = ''
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.owlmap = str[start:end].decode('utf-8')
      else:
        self.owlmap = str[start:end]
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
_struct_I = genpy.struct_I
class GenerateSemanticMapOWL(object):
  _type          = 'knowrob_semantic_map_msgs/GenerateSemanticMapOWL'
  _md5sum = '1c2a6a53cc387a95913217b540ce8670'
  _request_class  = GenerateSemanticMapOWLRequest
  _response_class = GenerateSemanticMapOWLResponse
