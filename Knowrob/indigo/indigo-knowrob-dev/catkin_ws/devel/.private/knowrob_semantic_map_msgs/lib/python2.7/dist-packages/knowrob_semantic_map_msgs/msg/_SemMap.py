...
"""autogenerated by genpy from knowrob_semantic_map_msgs/SemMap.msg. Do not edit."""
import sys
...
class SemMap(genpy.Message):
  _md5sum = "0e7108a9a0ef8f86a3826823d610e711"
  _type = "knowrob_semantic_map_msgs/SemMap"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Semantic map message type, Moritz Tenorth, tenorth@cs.tum.edu
...
"""
  __slots__ = ['header','namespace','id','prefixes','imports','address','objects','actions','object_properties','data_properties']
  _slot_types = ['std_msgs/Header','string','string','knowrob_semantic_map_msgs/SemMapPrefix[]','string[]','knowrob_semantic_map_msgs/SemMapAddress','knowrob_semantic_map_msgs/SemMapObject[]','knowrob_semantic_map_msgs/SemMapAction[]','knowrob_semantic_map_msgs/SemMapObjectProperty[]','knowrob_semantic_map_msgs/SemMapDataProperty[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,namespace,id,prefixes,imports,address,objects,actions,object_properties,data_properties
