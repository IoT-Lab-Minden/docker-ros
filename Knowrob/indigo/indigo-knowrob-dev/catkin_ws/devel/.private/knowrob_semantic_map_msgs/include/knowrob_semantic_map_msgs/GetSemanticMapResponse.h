// Generated by gencpp from file knowrob_semantic_map_msgs/GetSemanticMapResponse.msg
// DO NOT EDIT!


#ifndef KNOWROB_SEMANTIC_MAP_MSGS_MESSAGE_GETSEMANTICMAPRESPONSE_H
#define KNOWROB_SEMANTIC_MAP_MSGS_MESSAGE_GETSEMANTICMAPRESPONSE_H
...
struct GetSemanticMapResponse_
{
  ...
  typedef boost::shared_ptr< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> const> ConstPtr;

}; // struct GetSemanticMapResponse_

typedef ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<std::allocator<void> > GetSemanticMapResponse;

typedef boost::shared_ptr< ::knowrob_semantic_map_msgs::GetSemanticMapResponse > GetSemanticMapResponsePtr;
typedef boost::shared_ptr< ::knowrob_semantic_map_msgs::GetSemanticMapResponse const> GetSemanticMapResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3236e705e162d6baULL;
  static const uint64_t static_value2 = 0x9e0bfae7b9d0cf43ULL;
};

template<class ContainerAllocator>
struct DataType< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "knowrob_semantic_map_msgs/GetSemanticMapResponse";
  }
...
template<class ContainerAllocator>
struct Definition< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "SemMap map\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::knowrob_semantic_map_msgs::GetSemanticMapResponse_<ContainerAllocator>& v)
  {
    s << indent << "map: ";
    s << std::endl;
...
#endif // KNOWROB_SEMANTIC_MAP_MSGS_MESSAGE_GETSEMANTICMAPRESPONSE_H
